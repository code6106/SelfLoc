...
def set_dataset_dir(dataset_name, root_dir):
    if dataset_name == "ECSSD":
        ...
        dataset_dir = os.path.join(root_dir, "COD10K")
        img_dir = os.path.join(dataset_dir, "Test/Image")
        gt_dir = os.path.join(dataset_dir, "Test/GT_Object")
    elif dataset_name == "CAMO":
        dataset_dir = os.path.join(root_dir, "TestDataset/CAMO")
        img_dir = os.path.join(dataset_dir, "Imgs")
        gt_dir = os.path.join(dataset_dir, "GT")

    elif dataset_name == "CHAMELEON":
        dataset_dir = os.path.join(root_dir, "CHAMELEON")
        img_dir = os.path.join(dataset_dir, "Imgs")
        gt_dir = os.path.join(dataset_dir, "GT")
